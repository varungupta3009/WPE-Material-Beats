...
function r(){q=[];g=Math.floor(Math.floor(e.width*e.height/5E3)*n/4);for(var a=0;a<g;a++)q.push(new t)}window.wallpaperPropertyListener={applyUserProperties:function(a){a.point_density&&(n=a.point_density.value,r());if(a.background_color){var b=a.background_color.value.split(" ").map(function(d){return Math.ceil(255*d)});e.style.backgroundColor="rgb("+b+")"}a.background_image&&(a.background_image.value?(e.style.backgroundImage="url(file:///"+a.background_image.value+")",e.style.backgroundSize="100% 100%"):e.style.backgroundImage="none");a.point_size&&(k=a.point_size.value/1.5);a.beat_smoothness&&(p=1-a.beat_smoothness.value/10);a.show_points&&(l=a.show_points.value);a.move_on_beats&&(m=a.move_on_beats.value)}};
